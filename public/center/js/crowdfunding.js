...
function listClick(value){
	...
	if(value == 3){
		...
		$("#crowdfunding_iframe").attr("src","/center/crowdfunding.center/identity_prove.html");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
	...
	if(value == 4){
		...
		$("#crowdfunding_iframe").attr("src","/center/crowdfunding.center/make_password.html");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
	...
	if(value == 5){
		$("#crowdfunding_iframe").attr("src","/center/crowdfunding.center/apply_lingtou.html");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
	...
	if(value == 6){
		$("#crowdfunding_iframe").attr("src","/center/crowdfunding.center/project_manage.html");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
	...
	if(value == 7){
		$("#crowdfunding_iframe").attr("src","/center/crowdfunding.center/touhou_manage.html");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
	...
	if(value == 8){
		$("#crowdfunding_iframe").attr("src","/center/crowdfunding.center/my_account.html");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
	...
	if(value == 9){
		$("#crowdfunding_iframe").attr("src","/center/crowdfunding.center/investment_inquiry.html");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
	...
	if(value == 10){
		$("#crowdfunding_iframe").attr("src","/center/crowdfunding.center/apply_refund.html");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
	...
	if(value == 11){
		...
		$("#crowdfunding_iframe").attr("src","/center/crowdfunding.center/grade_integration.html");
	...
	if(value == 12){
		...
		$("#crowdfunding_iframe").attr("src","/center/crowdfunding.center/integration_record.html");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
	...
	if(value == 13){
		...
		$("#crowdfunding_iframe").attr("src","/center/crowdfunding.center/integration_rule.html");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
	...
	if(value == 14){
		$("#crowdfunding_iframe").attr("src","/center/crowdfunding.center/messages.html");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
	...
	if(value == 15){
		$("#crowdfunding_iframe").attr("src","/center/crowdfunding.center/inbox.html");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
	...
	if(value == 16){
		$("#crowdfunding_iframe").attr("src","/center/crowdfunding.center/outbox.html");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
