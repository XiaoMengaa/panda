...
<<<<<<< HEAD
                <form accept-charset="UTF-8" action="" class="navbar-search pull-right hidden-phone" method="get" action="/admin/user"><div style="margin:300;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
=======
